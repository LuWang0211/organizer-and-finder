...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-14 items-stretch justify-center rounded-full border-4 border-border bg-card p-0 gap-0",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "text-text-main/70 hover:text-text-main hover:bg-card/50 rounded-full",
      "focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-outline focus-visible:ring-offset-2",
      "disabled:pointer-events-none disabled:opacity-60",
      "data-[state=active]:outline-solid data-[state=active]:outline-border data-[state=active]:outline-3",
