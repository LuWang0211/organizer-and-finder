  ...
  variants: {
    variant: {
      primary: [
        ...
        "shadow-[-2px_2px_1px_0.5px_color-mix(in_oklch,var(--color-highlight)_30%,transparent)_inset,2px_-2px_1px_0.5px_color-mix(in_oklch,var(--color-primary-accent),black_25%)_inset]",
        "hover:scale-[1.02] hover:shadow-[-3px_3px_2px_1px_color-mix(in_oklch,var(--color-highlight)_35%,transparent)_inset,3px_-3px_2px_1px_color-mix(in_oklch,var(--color-primary-accent),black_30%)_inset]",
        ...
        "disabled:shadow-[-2px_2px_1px_0px_color-mix(in_oklch,var(--color-highlight)_12%,transparent)_inset,2px_-2px_1px_0px_color-mix(in_oklch,var(--color-primary-accent),black_50%)_inset] disabled:hover:scale-100 disabled:active:translate-y-0 disabled:saturate-50",
      ],
      secondary: [
        "bg-mute text-foreground",
        "shadow-[3px_-3px_2px_1px_color-mix(in_oklch,var(--color-mute),black_30%)_inset]",
        "hover:scale-[1.02] hover:shadow-[3px_-3px_2px_1px_color-mix(in_oklch,var(--color-mute),black_30%)_inset]",
        "disabled:bg-gray-400 disabled:text-gray-700 disabled:cursor-not-allowed",
        "disabled:shadow-[2px_-2px_1px_0px_color-mix(in_oklch,var(--color-mute),black_60%)_inset] disabled:hover:scale-100 disabled:active:translate-y-0",
      ],
      outline: [
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    return (
      <div
        className={cn(
          "relative group/button inline-block",
          disabled && "group-disabled/button",
        )}
      >
