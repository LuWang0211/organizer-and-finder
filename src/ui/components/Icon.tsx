...
import { ICON_COMPONENTS } from "@/ui/iconPresets";
...
const iconVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default: [
          "bg-linear-to-bl from-[color-mix(in_oklch,var(--color-card-default),white_80%)] via-card-default to-card-default",
          "hover:shadow-[0_4px_8px_0_rgba(0,0,0,0.15)_inset,3px_-3px_8px_0_color-mix(in_oklch,var(--color-card-default),black_12%)_inset]",
        ],
        primary: [
          "bg-linear-to-bl from-[color-mix(in_oklch,var(--color-primary-accent),white_80%)] via-primary-accent to-primary-accent text-white",
          ...
          "hover:shadow-[-3px_3px_2px_1px_color-mix(in_oklch,var(--color-highlight)_35%,transparent)_inset,3px_-3px_2px_1px_color-mix(in_oklch,var(--color-primary-accent),black_30%)_inset]",
        ],
        secondary: [
        ...
        highlight: [
          ...
          "hover:shadow-[0_4px_8px_0_rgba(0,0,0,0.2)_inset,3px_-3px_8px_0_color-mix(in_oklch,var(--color-highlight-300),black_20%)_inset]",
        ],
      },
      size: {
        tiny: "w-6 h-6",
...
const Icon = React.forwardRef<HTMLDivElement, IconProps>(
  (
    { className, variant, size = "default", border, iconKey, ...props },
    ref,
  ) => {
