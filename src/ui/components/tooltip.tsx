...
const CARD_CONTENT_CLASSES = "tooltip-card-content [&_span:has(>_svg.tooltip-card-arrow)]:z-20 [&:has(.card-content:hover)]:[&_svg.tooltip-card-arrow]:translate-y-[-9px]";

const CardArrowComponent = () => <svg
  className="tooltip-card-arrow translate-y-[-10px] fill-[hsl(var(--card))] transition-transform duration-200 ease-out"
  width="18"
  height="16"
  viewBox="0 0 30 22"
