  ...
  return (
    <div className={cn("w-full h-full flex items-center justify-center p-6", className)}>
      <div className="relative group">
        ...
        <div className="rounded-3xl border-4 border-border text-text-main overflow-hidden bg-card px-8 py-6 shadow-[0_2px_8px_0_hsl(var(--shadow)/20%)_inset,2px_-2px_8px_0_color-mix(in_oklch,hsl(var(--card)),black_10%)_inset]">
