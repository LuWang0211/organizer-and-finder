...
export class LoaderScene extends Phaser.Scene {
    ...
    create() {
        this.anims.create({
			key: "anime1",
			frames: sortBy(this.textures.get("loader").getFrameNames()).map((frame) => ({ key: "loader", frame: frame })),
			frameRate: 15,
			repeat: 0,
		  });
    ...
    preload() {
		this.load.atlas("loader", "assets/animation/loader.png", "assets/animation/loader.json");
	}
