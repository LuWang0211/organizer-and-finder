...
type TextWithPhysicsBody = Phaser.GameObjects.Text & { body: Phaser.Physics.Arcade.Body };
...
class LetterFallControl {
    ...
    public constructor(scene: Phaser.Scene, x: number, y: number, text: string) {
        this.text = scene.add.text(x, y, text, { fontSize: '32px', stroke: '#000' }) as TextWithPhysicsBody;
